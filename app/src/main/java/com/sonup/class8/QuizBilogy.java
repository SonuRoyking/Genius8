...
public class QuizBilogy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_bilogy);
        ...
        list = new ArrayList<>();
        list.add(new QuestionModel("Transport System in plants consists of", "Xylem", "Phloem", "Both", "None", "Both"));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(QuizBilogy.this, ScreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizBilogy.this , QuizActivity.class);
