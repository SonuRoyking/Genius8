...
public class QuizEnglish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new QuestionModel("Opposite of Wisdom", "Intelligence", "Beauty ", "Folly", "Vigour", "Folly"));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(QuizEnglish.this, ScreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizEnglish.this , QuizActivity.class);
