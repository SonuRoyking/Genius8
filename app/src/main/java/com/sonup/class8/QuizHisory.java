...
public class QuizHisory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_hisory);
        ...
        list.add(new QuestionModel("Mugal Dynasty was started by ", "Akbar", "SherShah", "Shah Jahan", "Babur", "Babur"));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(QuizHisory.this, ScreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizHisory.this , QuizActivity.class);
