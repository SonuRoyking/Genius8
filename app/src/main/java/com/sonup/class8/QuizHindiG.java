...
public class QuizHindiG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_hindi_g);
        ...
        list.add(new QuestionModel("2. पवर्ग का उच्चारण स्थान है ?", "दन्त", "कण्ठ", "ओष्ठ", "मूर्धा", "ओष्ठ"));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(QuizHindiG.this, ScreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizHindiG.this , QuizActivity.class);
