...
public class QuizPhysics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new QuestionModel("The intermlecular spaces in case of liquids are -", "less than the solids", "more than the gases ", "more than the solids and less than the gases", "more than the solids and gases", "less than the solids"));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(QuizPhysics.this, ScreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizPhysics.this , QuizActivity.class);
