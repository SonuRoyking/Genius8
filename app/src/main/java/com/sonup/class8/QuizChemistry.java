...
public class QuizChemistry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_chemistry);
        ...
        list = new ArrayList<>();
        list.add(new QuestionModel("The most electronegative element among the following is", "Sodium", "Bromine", "Fluorine", "Oxygen", "Fluorine"));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(QuizChemistry.this, ScreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizChemistry.this , QuizActivity.class);
